...
<span style='font-size:50px;'>"Multi-functional teams, with strengthened data literacy, regularly conduct meaningful and documented joint data interpretation sessions to define their strategic directions based on statistical evidences"</span>
...
potential aspect of resistance...

 *  I do not know how to eat it: I see all those elements on it without being able to understnad why you add them...
 ...
 *  This is not the cake I need: It looks too heavy and I will not be able to digest it... 
...
???
 simple data visualisation for decision making or complex patterns interpretation for knowledge building
---

## What & When? 

Dashbaord with PowerBI, Notebook with R & Machine Learning with Python... 
...
<span style='font-size:30px;'>Science is '_show me_' - not '_trust me_'</span>
 

 Reproducibility allows for __peer review__
...
.pull-right[
.img85[![Eat the cake](images/ethics.jpeg)] 
]
...
<span style='font-size:30px;'>Effective and motivating approach to learn start from an end-product that one can __reverse engineer__!</span>

Let them eat the cake (first - you can tell them the ingredient later...)

What is the appealing exercise among the 2 at right! 
...
.pull-left[
Data Wrangling takes usually more than 80% of projec time...
...
## Documentating all your scripts
...
.pull-right[
.img[![Eat the cake](images/exploration.jpeg)] 
]
...
.pull-right[
.img[![Eat the cake](images/read.png)] 
]
...
<span style='font-size:50px;'>you are not alone</span>
 ...
 - Existing packages that you can already re-use
