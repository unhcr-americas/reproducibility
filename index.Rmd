...
Many users can use focused R functions through dedicated __Graphical User Interface__ (GUI). If a package include a GUI, then no need for the package user to learn writing R scripts...
...
## An R-Community geared to learning 
 ...
 * Level 5: <span style='font-size:30px;'>Graphical User Interface (GUI)</span> 
]
.pull-right[
